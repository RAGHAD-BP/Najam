 ...
 * @author rawan
 */
public class Najam extends System_1 {
    ...
    public Najam(){
     ...
     switch(input){
              case 1: schedule();break;
                   ...
                   case 3: timePlan();break;
                     case 4: activities();break;
                      default:
            ...
            System.out.println("your null input");
    }
    
    public void servsi(){
         System.out.println("you need anthor thing?");
                answer=scan.next();
     ...
     switch(input){
         ...
         System.out.println("Choose:\n"+"1.Make a schedule"+"2.display your schedule");
...
int input= scan.nextInt();
    ...
    public void ToDoList(){ 
         System.out.println("Chooes:\n"+"1.add task \n"+"2.done task\n"+" 3.show all task\n"+" 4.delet task\n"+"5.remove douple");
         if(scan.hasNextInt()){
                  int input= scan.nextInt(); 
         switch(input){ 
            case 1 : System.out.println("Enter you task:"
                    + "if you finish inter finish");
        String Todo=scan.next();
        while(!(Todo.equalsIgnoreCase("finish"))){
                addtask(Todo);
        Todo=scan.next();
            ...
            servsi();
            break;
                case 2: super.showToDoList();
                    System.out.println("Enter the number of task you done it:"); 
                ...
                break;
                    ...
                    case 4:{
                        super.showToDoList();
                        System.out.println(" Enter 1.delet complement task 2.delet not complement:");
                        if(scan.hasNextInt()){
                        int i=s.nextInt();
                        if(i==1){
                            System.out.println("what do you want to delet?");
                            String delet=scan.next();
                            super.deletcom(delet);
                        }else if(i==2)
                            System.out.println("what do you want to delet?");
                            String delet=scan.next();
                    super.deletnotcom(delet);
                    }
                        else{
                            System.out.println("you are inter in corrct try again");}
                    
                    servsi();}
                        break;
                    case 5:
                        System.out.println(removeDouple(notComplement)); 
